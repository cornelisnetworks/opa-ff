...
for i in $basic_tools_sbin opaportconfig opapmaquery
do
...
for i in $help_doc
do
	echo "/usr/share/opa/help/$i" >> ${BUILDDIR}/ff_file.list
done
...
do
	echo "/usr/share/opa/samples/$i" >> ${BUILDDIR}/ff_file.list
done
cd ..
...
do
	echo "/usr/src/opa/mpi_apps/$i" >> ${BUILDDIR}/ff_file.list
done
cd ../../
...
do
	echo "/usr/src/opa/shmem_apps/$i" >> ${BUILDDIR}/ff_file.list
done
cd ../../
